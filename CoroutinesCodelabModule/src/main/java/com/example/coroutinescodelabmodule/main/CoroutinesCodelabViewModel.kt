...
import com.example.coroutinescodelabmodule.util.singleArgViewModelFactory
 ...
 */
class CoroutinesCodelabViewModel(private val repository: TitleRepository) : ViewModel() {

    companion object {
        /**
         * Factory for creating [CoroutinesCodelabViewModel]
         *
         * @param arg the repository to pass to [CoroutinesCodelabViewModel]
         */
        val FACTORY = singleArgViewModelFactory(::CoroutinesCodelabViewModel)
    }
