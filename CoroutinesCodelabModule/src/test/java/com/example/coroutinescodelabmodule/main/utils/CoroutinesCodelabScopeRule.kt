...
package com.example.coroutinescodelabmodule.main.utils
 ...
 * ```
 *
 * All coroutines started on [CoroutinesCodelabScopeRule] must complete (including timeouts) before the test
 ...
 * ```
 *
 * You may call [DelayController] methods on [CoroutinesCodelabScopeRule] and they will control the
 * virtual-clock.
 *
 * ```
 ...
 * ```
 *
 * By default, [CoroutinesCodelabScopeRule] will be in a *resumed* state.
 *
 * @param dispatcher if provided, this [TestCoroutineDispatcher] will be used.
 */
@ExperimentalCoroutinesApi
class CoroutinesCodelabScopeRule(val dispatcher: TestCoroutineDispatcher = TestCoroutineDispatcher()) :
        TestWatcher(),
